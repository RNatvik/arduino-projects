...
*/
{
  public:
    ...
    void transmit();
    void transmit(int registers[], int num);
    ...
    void write_bool(int reg_num, bool value);
    void write_byte(int reg_num, byte value);
    void write_int(int reg_num, int value);
    void write_float(int reg_num, float value);
    void write_long(int reg_num, long value);
    void write_uint(int reg_num, unsigned int value);
    void write_ulong(int reg_num, unsigned long value);
  ...
  private:
    ...
    /**
       ...
       This message is destined for register 2 (0x02) (0 indexed)
